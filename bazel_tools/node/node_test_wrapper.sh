...
# mkdir -p "${JS_BINARY__RUNFILES}/node_modules/unity"
# ls -al "${JS_BINARY__RUNFILES}/unity/trumid"
# cp -rp "${JS_BINARY__RUNFILES}/unity/trumid" "${JS_BINARY__RUNFILES}/node_modules/unity"
